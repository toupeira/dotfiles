# Generated by Powerlevel10k configuration wizard on 2024-03-02 at 18:09 CET.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%2F'    # default foreground
      local      clean='%10F'   # green foreground
      local   modified='%10F'   # green foreground
      local  untracked='%10F'   # green foreground
      local conflicted='%11F'   # yellow foreground
    else
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      res+="${clean}%B${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}${branch//\%/%%}"
    fi

    # Display the current Git commit if there is no branch and no tag.
    # Tip: To always display the current Git commit, delete the next line.
    [[ -z $VCS_STATUS_LOCAL_BRANCH && -z $VCS_STATUS_TAG ]] &&  # <-- this line
      res+="${meta}[${clean}%B${VCS_STATUS_COMMIT[1,8]}%b${meta}]"
    ...
    [[ -n $VCS_STATUS_ACTION     ]] && res+=" ${conflicted}${VCS_STATUS_ACTION:u}"
  ...
  # Disable counters for staged, unstaged, etc.
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND=13
  # Custom icon.
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_VISUAL_IDENTIFIER_EXPANSION=

  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_PREFIX='['
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_SUFFIX=' jobs]'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%B%8F%n%11F@%m'
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%8F 𝝺'
