...
let s:airline_modified = [s:colors.yellow.gui, '', s:colors.yellow.cterm, '', s:wrap_opts(['italic'])]
...
let s:airline_c_normal = [s:colors.white.gui, s:colors.white_mask_1.gui, s:colors.white.cterm, s:colors.white_mask_1.cterm, s:wrap_opts(['bold', 'italic'])]
...
let s:airline_a_commandline = [s:colors.black.gui, s:colors.blue.gui, s:colors.black.cterm, s:colors.blue.cterm]
