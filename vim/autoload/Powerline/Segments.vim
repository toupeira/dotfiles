let g:Powerline#Segments#segments = Pl#Segment#Init(
  ...
  \
  \ Pl#Segment#Create('mode_indicator'  , '%{tolower(Powerline#Functions#GetMode())}'),
  ...
  \ Pl#Segment#Create('filepath'        , '%<%{expand("%:h")}'),
  ...
  \ Pl#Segment#Create('scrollpercent'   , '%3p%%', Pl#Segment#Modes('!N')),
  \ Pl#Segment#Create('lineinfo',
    \ Pl#Segment#Create('line.cur'    , '$LINE %3l'),
    \ Pl#Segment#Create('line.tot'    , '/ %3L'),
    \ Pl#Segment#Create('line.col'    , '$COL %-2c'),
  \ ),
