...
let g:Powerline#Colorschemes#desertink#colorscheme = Pl#Colorscheme#Init([
  ...
  \ Pl#Colorscheme#HiSegment(['filepath'],                            Pl#Hi#Create(Pl#Hi#Cterm(248, 238)        ), { 'N': Pl#Hi#Create(Pl#Hi#Cterm(244, 236)        ), 'i': Pl#Hi#Create(Pl#Hi#Cterm(231,  31)        ), } ),
  ...
  \                           'pwd',
  \                           'filetype',
  \                           'charcode'],                            Pl#Hi#Create(Pl#Hi#Cterm(242, 236)        ), { 'N': Pl#Hi#Create(Pl#Hi#Cterm(238, 236)        ), 'i': Pl#Hi#Create(Pl#Hi#Cterm(117,  24)        ), } ),
